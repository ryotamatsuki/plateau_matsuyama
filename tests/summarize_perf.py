...
for device in ['desktop', 'iphone']:
    ...
    lines += [
        ...
        f'| water Cesium primitive count | {b["water"]["primitiveCount"]} | {c["water"]["primitiveCount"]} |',
        '',
        ...
        f'Water visible-state signature: **{b["water"]["status"]}**. Primitive composition and material uniforms match the baseline.',
        '',
    ]
...
lines += [
    ...
    '- 3D water: PASS (same visible instance/radius/depth status, primitive composition, material uniforms, and frozen-scene image within tolerance).',
